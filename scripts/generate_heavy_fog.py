...
OUTPUT_DIR = "images_foggy/heavy"
META_DIR = "metadata/heavy"

os.makedirs(OUTPUT_DIR, exist_ok=True)
os.makedirs(META_DIR, exist_ok=True)

# ==============================
# HEAVY FOG PARAMETERS
# ==============================
...
A_R_MIN, A_R_MAX = 0.85, 0.98
A_G_MIN, A_G_MAX = 0.87, 0.98
A_B_MIN, A_B_MAX = 0.88, 0.99
...
for img_file in sorted(os.listdir(CLEAR_IMG_DIR)):
    ...
    for var in range(NUM_VARIANTS):
        ...
        out_name = f"{base}_heavyfog_v{var}_beta{beta:.3f}.jpg"
...
print(f"✅ Heavy fog generation completed: {_total} images.")
